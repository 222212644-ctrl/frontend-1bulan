<header class="bg-[#F9F8F4] shadow-md font-posterable">
    <div class="container mx-auto px-4 flex justify-between items-center py-4">
        ...
        <!-- Mobile Menu Button -->
        <button class="lg:hidden text-green-800 focus:outline-none hover:text-green-600 transition"
        ...
        <nav class="hidden lg:flex items-center space-x-8 text-green-800">
            <a wire:navigate href="/"
                class="hover:text-green-600 hover:border-b-4 hover:border-green-800">Beranda</a>
            <a href="{{ route('petausaha') }}" class="hover:text-green-600 hover:border-b-4 hover:border-green-800">Peta
                Usaha</a>
    ...
    @if ($isMenuOpen)
        <div class="lg:hidden bg-[#F9F8F4] flex flex-col space-y-2 px-4 py-4">
